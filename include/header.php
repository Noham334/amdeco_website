      ...
      <ul class="navbar-nav mb-2 mb-lg-0 justify-content-around">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-dark">
            ...
            <li><a class="dropdown-item" href="http://localhost/amdeco_website/publicaciones\libros.php" target="_parent"><img src="http://localhost/amdeco_website/publicaciones/iconos/Libros.png" alt="">Libros</a>
            </li>
            <li><a class="dropdown-item" href="http://localhost/amdeco_website/publicaciones\folletos.php" target="_parent"><img src="http://localhost/amdeco_website/publicaciones/iconos/folletos.png" alt="">Folletos</a>
            </li>
            <li><a class="dropdown-item" href="http://localhost/amdeco_website/publicaciones\leyes.php" target="_parent"><img src="http://localhost/amdeco_website/publicaciones/iconos/leyes.png" alt="">Leyes</a>
            </li>
            <li><a class="dropdown-item" href="http://localhost/amdeco_website/publicaciones\municipios.php" target="_parent"><img src="http://localhost/amdeco_website/publicaciones/iconos/municipios.png" alt="">Municipios</a>
            </li>
            <li><a class="dropdown-item" href="http://localhost/amdeco_website/publicaciones\amdeco.php" target="_parent"><img src="http://localhost/amdeco_website/publicaciones/iconos/amdeco.png" alt="">Amdeco</a>
            </li>
            <li><a class="dropdown-item" href="http://localhost/amdeco_website/publicaciones\otros.php" target="_parent"><img src="http://localhost/amdeco_website/publicaciones/iconos/varios.png" alt="">Otros</a>
            </li>
          </ul>
        </li>
        ...
        <li class="nav-item"><a class="nav-link" href="http://localhost/amdeco_website/contactos.php">Contacto</a>
      </ul>
    </div>
  </div>
</nav>