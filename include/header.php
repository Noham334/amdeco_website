<nav>
  ...
  <ul class="nav-list">
    <li class="d-flex align-items-center"><a href="index.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
    ...
    <li><a href="http://localhost/amdeco_website/municipios.php">Municípios</a></li>
