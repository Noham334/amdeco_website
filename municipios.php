  ...
  <body>
    <div class="page">
	  ...
	  <!--Regiones de Cochabamba -->
        <section>	
  	  <center><h2>Regiones de Cochabamba</h2></center>		
       ...
       <div id="map">
        ...
        <script src="enlacemunicipios/mapa/resources/Autolinker.min.js"></script>
                  ...
                  <div class="grid_4">
                      ...
                      <p><li>Comprende 7 Gobiernos Municipales: Cochabamba, Colcapirhua, Quillacollo, Sacaba, Sipe Sipe, Tiquipaya, Vinto.</li></p>
                      <div class="fleft"><strong>Valles:</strong></div>
                      <p><li>Comprende 15 Gobiernos Municipales:Punata, Capinota, Santivañez, Arani, Villa Rivero, Cliza, Toco, Tolata, Tarata, Anzaldo, Sacabamba, Arbieto, Tacahi, Villa Gualberto Villarroel (Cuchumuela) y San Benito.</li></p>
                      <div class="fleft"><strong>Trópico:</strong></div>
                      <p><li>Comprende 6 Gobiernos Municipales: Entre Rios, Shinahota, Colomi, Puerto Villarroel, Villa tunari, Chimore.</li></p>
                      <div class="fleft"><strong>Cono Sur:</strong></div>
                      <p><li>Comprende 11 Gobiernos Municipales: Vacas, Tiraque, Alalay, Mizque, Aiquile, Vila Vila, Pojo, Omereque, Totora, Pocona y Pasorapa.</li></p>
                      <div class="fleft"><strong>Andina:</strong></div>
                      <p><li>Comprende 8 Gobiernos Municiaples: Bolivar, Cocapata, Independencia, Morochata, Tapacare, Tacopaya, Sicaya y Arque.</li></p>
...
Entre Ríos se encuentra en una de las regiones con mayor potencialidad en la producción de alimentos e hidrocarburos. Sus más de 30 mil habitantes se dedican a la actividad ganadera, piscícola y avícola, también al cultivo de granos, como el arroz, maíz, soya; frutas como la piña y el plátano de exportación. Además, se produce café, papaya, sandías y otros."  /></a>
  ...
  <ul id="list"> 
          ...
          <li class="hide"><a href=" enlacemunicipios/raqaypampa.php" target="_blank" ><img src="enlacemunicipios/searchShield/escudos/raqaypampa.jpg" width="50" height="50"  align="absmiddle"/>Raqaypampa</a></li>
				...
				<li class="hide"><a href="mapa/pagina.php" target="_blank" ><img src="enlacemunicipios/searchShield/escudos/cercado_escudo.jpg" width="50" height="50" align="absmiddle"/> Cercado</a></li>				      
	</ul> 
