...
<?php
include_once 'phpMunicipios/config.inc.php';
if (isset($_POST['subir'])) {
    $nombre = $_FILES['archivo']['name'];
    $tipo = $_FILES['archivo']['type'];    
    $ruta = $_FILES['archivo']['tmp_name'];
    $destino = "phpMunicipios/archivos/" . $nombre;
    if ($nombre != "") {
        if (copy($ruta, $destino)) {
            ...
            $db=new Conect_MySql();
            $sql = "INSERT INTO tbl_municipios(titulo,descripcion,fecha,tipo,nombre_archivo) VALUES('$titulo','$descri','$fecha'  ,'$tipo','$nombre')";
...
<!-- CARGAR REGISTRO A NUESTRA TABLA-->
  <div class="container">                                 
        ...
        $db=new Conect_MySql();
            $sql = "select*from tbl_municipios order by fecha desc";
            $query = $db->execute($sql);
...
<td><center><a class="btn btn-success" href="phpMunicipios/archivos/<?php echo $datos["nombre_archivo"];?>"download> <i class="fa fa-download" aria-hidden="true"></i></a></center></td>
 ...
 window.location.href='phpMunicipios/del.php?id=' +id+'';
 return true;
 }
 } 
 </script>
