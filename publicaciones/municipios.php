...
<body>
  ...
  <div class="page">
        ...
        <table class="table table-hover" id="employee_table">
          ...
          while ($datos = $db->fetch_row($query)) { ?>
            <tr>
              ...
              <td>
                <center><a class="btn btn-success" href="phpMunicipios/archivos/<?php echo $datos["nombre_archivo"]; ?>" download> <i class="fa fa-download" aria-hidden="true"></i></a></center>
              </td>
    ...
    <script src="js/jquery.migrate-1.2.1js"></script>
