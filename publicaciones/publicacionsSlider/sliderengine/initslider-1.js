jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        navpreviewwidth:120,
        googlefonts:"Inder",
        navborderhighlightcolor:"#91CFE9",
        bordercolor:"#5AB7DE",
        ...
        navbordercolor:"#5AB7DE",
        navthumbmediumcolumn:4,
        navpreviewarrowimage:"previewarrow-16-8-0.png",
        navthumbtitlecss:"display:block;position:relative;padding:2px 4px;text-align:left;font:bold 14px Arial,Helvetica,sans-serif;color:#434547;",
