...
<html lang="en" class="no-js">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>     
    <link rel="stylesheet" href="../phpVarios/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="../phpVarios/font-awesome/css/font-awesome.min.css">
	  <link rel="stylesheet" href="../phpVarios/css/form-elements.css">
    <link rel="stylesheet" href="../phpVarios/css/style.css">
		<link rel="stylesheet" type="text/css" href="../phpVarios/css/normalize.css" />
			
		<link rel="stylesheet" type="text/css" href="../phpVarios/css/component.css" />
          ...
          <div class="container">
            <nav class="nav">
                ...
                <li><a href="http://localhost/amdeco/publicaciones/phpLibros/phplibros.php">Libros</a></li>
                    <li ><a href="/amdeco/publicaciones/phpfolletos/phpfolletos.php">Folletos</a></li>
                    ...
                    <li class="active"><a href="/amdeco/publicaciones/phpVarios/phpvarios.php">Otros</a></li>
                  </ul>
            </nav>
          </div>
        </div>
...
<?php
include_once '../phpVarios/config.inc.php';
if (isset($_POST['subir'])) {
    $nombre = $_FILES['archivo']['name'];
    $tipo = $_FILES['archivo']['type'];    
    $ruta = $_FILES['archivo']['tmp_name'];
    $destino = "../phpVarios/archivos/" . $nombre;
    if ($nombre != "") {
        if (copy($ruta, $destino)) {
            ...
            $db=new Conect_MySql();
            $sql = "INSERT INTO tbl_otros(titulo,descripcion,fecha,tipo,nombre_archivo) VALUES('$titulo','$descri','$fecha'	,'$tipo','$nombre')";
...
<!-- CARGAR REGISTRO A NUESTRA TABLA-->
	<div class="container">                                 
        ...
        $db=new Conect_MySql();
            $sql = "select*from tbl_otros order by fecha desc";
            $query = $db->execute($sql);
...
<td><center><a class="btn btn-success" href="../phpVarios/archivos/<?php echo $datos["nombre_archivo"];?>"download> <i class="fa fa-download" aria-hidden="true"></i></a></center></td>
 ...
 window.location.href='../phpVarios/del.php?id=' +id+'';
 return true;
 }
 } 
 </script>
...
<!-- END FUNCION PARA EL BUSCADOR-->
      ...
      <script src="../phpVarios/js/custom-file-input.js"></script>
