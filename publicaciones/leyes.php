...
<html lang="en" class="no-js">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>     
    <link rel="stylesheet" href="phpLeyes/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="phpLeyes/font-awesome/css/font-awesome.min.css">
       ...
       <header>
        ...
        <div id="stuck_container" class="stuck_container">
          <div class="container">
           ...
           <ul>
          <li><a href="..\publicaciones\libros.php" target="_parent"><img src="iconos\Libros.png" alt="">Libros</a><li>
            <li><a href="..\publicaciones\folletos.php" target="_parent"><img src="iconos\folletos.png" alt="">Folletos</a><li>
            <li><a href="..\publicaciones\leyes.php" target="_parent"><img src="iconos\leyes.png" alt="">Leyes</a><li>
            <li><a href="..\publicaciones\municipios.php" target="_parent"><img src="iconos\municipios.png" alt="">Municipios</a><li>
            <li><a href="..\publicaciones\amdeco.php" target="_parent"><img src="iconos\amdeco.png" alt="">Amdeco</a><li>
            <li><a href="..\publicaciones\otros.php" target="_parent"><img src="iconos\varios.png" alt="">Otros</a><li>
...
<?php
include_once 'phpLeyes/config.inc.php';
if (isset($_POST['subir'])) {
    $nombre = $_FILES['archivo']['name'];
    $tipo = $_FILES['archivo']['type'];    
    $ruta = $_FILES['archivo']['tmp_name'];
    $destino = "phpLeyes/archivos/" . $nombre;
    if ($nombre != "") {
        if (copy($ruta, $destino)) {
            ...
            $db=new Conect_MySql();
            $sql = "INSERT INTO tbl_leyes(titulo,descripcion,fecha,tipo,nombre_archivo) VALUES('$titulo','$descri','$fecha'  ,'$tipo','$nombre')";
...
<!-- CARGAR REGISTRO A NUESTRA TABLA-->
  <div class="container">                                 
        ...
        $db=new Conect_MySql();
            $sql = "select*from tbl_leyes order by fecha desc";
            $query = $db->execute($sql);
...
<td><center><a class="btn btn-success" href="phpLeyes/archivos/<?php echo $datos["nombre_archivo"];?>"download> <i class="fa fa-download" aria-hidden="true"></i></a></center></td>
 ...
 window.location.href='phpLeyes/del.php?id=' +id+'';
 return true;
 }
 } 
 </script>
...
<!-- END FUNCION PARA EL BUSCADOR-->
      ...
      <script src="phpLeyes/js/custom-file-input.js"></script>
