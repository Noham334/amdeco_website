<!--El baner es para editar la niticia-->
    ...
    <div class="container">
      ...
      <div class="row">
	   ...
	   <ol class="breadcrumb">
		...
		<div class="col-md-7">
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Editar Noticias</h3>
        ...
        <input type="date"  name="fecha" class="form-control"  placeholder="Lugar del evento"  value="<?php echo $fecha;?>">
			  ...
			  <div class="form-group">
				...
				<label for="url" class="col-sm-3 control-label">url</label> <br>
