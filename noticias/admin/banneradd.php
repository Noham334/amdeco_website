<!--este es para agregar nueva noticias-->
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <!-- Componente principal de un mensaje de marketing principal o llamada a la acción -->

      <div class="row">
 
		<ol class="breadcrumb">
		  <li><a href="#">Inicio</a></li>
		  <li><a href="bannerlist.php">Noticias</a></li>
		  <li class="active">Editar</li>
		</ol>
		
		<div class="col-md-7">
			<h3 ><span class="glyphicon glyphicon-edit"></span> Editar Noticia</h3>
			...
			<form class="form-horizontal" id="editar_banner">
			  ...
			  <div class="form-group">
				<label for="titulo" class="col-sm-3 control-label">Titulo de la Noticia</label>
				<div class="col-sm-9">
			  ...
			  <div class="form-group">
					<label for="orden" class="col-sm-3 control-label">Fecha de la Noticia</label>
					<div class="col-sm-9">
						<input type="date"  name="fecha" class="form-control"  placeholder="Lugar del evento"  value="<?php echo $fecha;?>">
					</div>
			  </div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9">
					<textarea class='form-control' name="url_descript" id="url_descript" required rows=8><?php echo $url_descript;?></textarea>
				</div>
			  </div>
		...
		<div class="col-md-5">
		 <h3 ><span class="glyphicon glyphicon-picture"></span> Imagen de la noticia</h3>
