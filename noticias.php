...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap-theme.min.css" integrity="sha384-rHyoN1iRsVXV4nD0JutlnGaslCJuC7uwjduW9SVrLvRYooPp2bWYgmgJQIXwl/Sp" crossorigin="anonymous">
    ...
    <center><title>Noticias Amdeco</title></center>
  ...
  <body>
    <div class="page">
      ...
      <div class='container'>
		<div class="row">
			<div class="col-lg-12">
				<center><h1 class="page-header">Noticias Amdeco</h1></center>
			<?php
				$nums=1;
				...
				while($rw_banner_top=mysqli_fetch_array($sql_banner_top)){
					...
					<div class="col-lg-3 col-md-4 col-xs-6 thumb">
						<a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title="<?php echo $rw_banner_top['titulo'];?>" data-caption="<?php echo $rw_banner_top['descripcion'];	?>" data-image="noticias/img/banner/<?php echo $rw_banner_top['url_image'];?>" data-target="#image-gallery"  data-url="<?php echo $rw_banner_top['url_descript'];?>">
                          ...
                          <p><center><button onclick="location.href='<?php echo $rw_banner_top['url_descript'];?>'"><br>Click para leer</br></button></center></p> 
...
<div class="modal fade" id="image-gallery" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <p><div class="col-md-7 text-justify" id="image-gallery-caption">
