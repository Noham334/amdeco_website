...
$insert=mysqli_query($con,"insert into alcaldes (url_image, estado) values ('$imagen_demo','0')");
$sql_last=mysqli_query($con,"select LAST_INSERT_ID(id) as last from alcaldes order by id desc limit 0,1");
$rw=mysqli_fetch_array($sql_last);
$id_banner=intval($rw['last']);
$sql=mysqli_query($con,"select * from alcaldes where id='$id_banner' limit 0,1");
    ...
    <div class="container">
      ...
      <div class="row">
	   ...
	   <ol class="breadcrumb">
		  ...
		  <li><a href="bannerlist.php">Alcaldes</a></li>
		  <li class="active">Editar</li>
		</ol>
		 <div class="col-md-7">
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Editar Alcalde</h3>
		 ...
		 <form class="form-vertical">
			...
			<div class="form-group">
				...
				<div class="col-sm-12">
				 ...
				 <div class="fileinput fileinput-new" data-provides="fileinput" style="max-width: 250px; max-height: 250px;">
								  <div class="fileinput-new thumbnail" style="max-width: 100%;" >
									  <img class="img-rounded" src="../img/banner/cargar.png ? echo $url_image;?>" />
								  </div>
