  ...
  <body>
    <div class="page">
     ...
     <div class="container-fluid">
          <div class="row">
            <div class="col-12 primero"> <center><Div id="organigrama" name="organigrama" class="organigrama">
                <div id="popup">
                 <ul id="ul1" name="ul1">
                   <li>
        ...
        <section class="well1 ins3">
          <div class="container">
            <center><ul><h3>Función Estratégica del Consejo Directivo</h3></ul></center>
